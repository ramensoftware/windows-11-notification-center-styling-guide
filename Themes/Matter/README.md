...
![Quick Actions Center](QuickActionCenter.png)  ![Notification Center](NotificationCenter.png) 
...
```json
{
  ...
  "styleConstants[1]": "base = <AcrylicBrush TintColor=\"{ThemeResource SystemAltLowColor}\" TintOpacity=\"1\" TintLuminosityOpacity=\"0.6`\" FallbackColor=\"{ThemeResource SystemChromeLowColor}\" />",
