...
To line the jumplists up properly when using a vertical taskbar, use one of the alternate versions below.
...
```json
{
	...
	"controlStyles[4].styles[2]": "Padding=0,5,0,5",
	"controlStyles[1].styles[2]": "BorderThickness=0,0,0,0",
	"controlStyles[3].styles[1]": "HorizontalAlignment=0"
}
```
</details>
...
```json
{
	...
	"controlStyles[4].styles[2]": "Padding=0,5,0,5",
	"controlStyles[1].styles[2]": "BorderThickness=0,0,0,0",
	"controlStyles[3].styles[1]": "HorizontalAlignment=2"
}
```
</details>
