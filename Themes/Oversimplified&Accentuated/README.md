...
```json
{
  ...
  "controlStyles[63].target": "Grid#FullScreenPageRoot > ContentPresenter#PageHeader > Border > Grid > Button#BackButton",
  "controlStyles[63].styles[0]": "CornerRadius=14,8,8,8",
  "controlStyles[63].styles[1]": "//Target= Control Center > Sub-Menu > Header > Back Button",
  
  "controlStyles[64].target": "ContentPresenter > Grid#FullScreenPageRoot",
  "controlStyles[64].styles[0]": "Background:=$DarkAccent",
  "controlStyles[64].styles[1]": "//Target= Control Center > Sub-Menus' Box",
  
  "controlStyles[65].target": "ContentPresenter#PageContent > Grid > Border",
  "controlStyles[65].styles[0]": "Background=Transparent",
  "controlStyles[65].styles[1]": "//Target= Control Center > Sub-Menus' Bodys (Part1)",
  
  "controlStyles[66].target": "Grid > ScrollViewer#ListContent",
  "controlStyles[66].styles[0]": "Background=Transparent",
  "controlStyles[66].styles[1]": "//Target= Control Center > Sub-Menus' Bodys (Part2)",
  
  "controlStyles[67].target": "Border#SwitchKnobOn",
  "controlStyles[67].styles[0]": "Background=",
  "controlStyles[67].styles[1]": "//Target= Control Center > Wifi & Bluetooth Sub-Menus > On/Off Switch (This used to solve an issue before 24H2)",
  
  "controlStyles[68].target": "StackPanel > ContentPresenter > Border",
  "controlStyles[68].styles[0]": "BorderBrush=Transparent",
  "controlStyles[68].styles[1]": "//Target= Control Center > Sub-Menus (Except Cast & WiFi) > Footer",
  
  "controlStyles[69].target": "Border#WADFeatureFooter",
  "controlStyles[69].styles[0]": "BorderBrush=Transparent",
  "controlStyles[69].styles[1]": "//Target= Control Center > Cast Sub-Menu > Footer",
  
  "controlStyles[70].target": "Grid#MediaTransportControlsRoot",
  "controlStyles[70].styles[0]": "Background=Transparent",
  "controlStyles[70].styles[1]": "//Target= Control Center > Media Panel > Overlay Layer",
  
  "controlStyles[71].target": "Grid#MediaTransportControlsRegion",
  "controlStyles[71].styles[0]": "Background:=$DarkAccent",
  "controlStyles[71].styles[1]": "BorderBrush=Transparent",
  "controlStyles[71].styles[2]": "CornerRadius=20",
  "controlStyles[71].styles[3]": "Height=Auto",
  "controlStyles[71].styles[4]": "Shadow:=",
  "controlStyles[71].styles[5]": "//Target= Control Center > Media Panel",
  
  "controlStyles[72].target": "Grid#MediaTransportControlsRoot > Grid[2]",
  "controlStyles[72].styles[0]": "Margin=-8,0,0,12",
  "controlStyles[72].styles[1]": "//Target= Control Center > Media Panel > App Name & icon",
  
  "controlStyles[73].target": "StackPanel#PrimaryAndSecondaryTextContainer",
  "controlStyles[73].styles[0]": "Visibility=Collapsed",
  "controlStyles[73].styles[1]": "//Target= Control Center > Media Panel > Media Name & Subtitles",
  
  "controlStyles[74].target": "Grid#AlbumTextAndArtContainer",
  "controlStyles[74].styles[0]": "HorizontalAlignment=Center",
  "controlStyles[74].styles[1]": "//Target= Control Center > Media Panel > Media Name & Thumbnail Container",
  
  "controlStyles[75].target": "Grid#ThumbnailImage",
  "controlStyles[75].styles[0]": "CornerRadius=15",
  "controlStyles[75].styles[1]": "Height=300",
  "controlStyles[75].styles[2]": "Width=300",
  "controlStyles[75].styles[3]": "//Target= Control Center > Media Panel > Media Thumbnail",
  
  "controlStyles[76].target": "Border#JumpListRestyledAcrylic",
  "controlStyles[76].styles[0]": "Background:=$DarkAccent",
  "controlStyles[76].styles[1]": "CornerRadius=15",
  "controlStyles[76].styles[2]": "Shadow:=",
  "controlStyles[76].styles[3]": "//Target= Taskbar Apps > Left Click Menu (Jumplist)",
  
  "controlStyles[77].target": "GridViewItem[1] > Windows.UI.Xaml.Controls.Primitives.ListViewItemPresenter#Root > ContentControl > ContentPresenter > Grid > Grid > ControlCenter.PaginatedToggleButton#ToggleButton",
  "controlStyles[77].styles[0]": "AccessKey=1",
  "controlStyles[77].styles[1]": "//Target= Control Center Button#1",
  
  "controlStyles[78].target": "GridViewItem[2] > Windows.UI.Xaml.Controls.Primitives.ListViewItemPresenter#Root > ContentControl > ContentPresenter > Grid > Grid > ControlCenter.PaginatedToggleButton#ToggleButton",
  "controlStyles[78].styles[0]": "AccessKey=2",
  "controlStyles[78].styles[1]": "//Target= Control Center Button#2",
  
  "controlStyles[79].target": "GridViewItem[3] > Windows.UI.Xaml.Controls.Primitives.ListViewItemPresenter#Root > ContentControl > ContentPresenter > Grid > Grid > ControlCenter.PaginatedToggleButton#ToggleButton",
  "controlStyles[79].styles[0]": "AccessKey=3",
  "controlStyles[79].styles[1]": "//Target= Control Center Button#3",
  
  "controlStyles[80].target": "GridViewItem[4] > Windows.UI.Xaml.Controls.Primitives.ListViewItemPresenter#Root > ContentControl > ContentPresenter > Grid > Grid > ControlCenter.PaginatedToggleButton#ToggleButton",
  "controlStyles[80].styles[0]": "AccessKey=4",
  "controlStyles[80].styles[1]": "//Target= Control Center Button#4",
  
  "controlStyles[81].target": "GridViewItem[5] > Windows.UI.Xaml.Controls.Primitives.ListViewItemPresenter#Root > ContentControl > ContentPresenter > Grid > Grid > ControlCenter.PaginatedToggleButton#ToggleButton",
  "controlStyles[81].styles[0]": "AccessKey=5",
  "controlStyles[81].styles[1]": "//Target= Control Center Button#5",
  
  "controlStyles[82].target": "GridViewItem[6] > Windows.UI.Xaml.Controls.Primitives.ListViewItemPresenter#Root > ContentControl > ContentPresenter > Grid > Grid > ControlCenter.PaginatedToggleButton#ToggleButton",
  "controlStyles[82].styles[0]": "AccessKey=6",
  "controlStyles[82].styles[1]": "//Target= Control Center Button#6",
  
  "controlStyles[83].target": "GridViewItem[7] > Windows.UI.Xaml.Controls.Primitives.ListViewItemPresenter#Root > ContentControl > ContentPresenter > Grid > Grid > ControlCenter.PaginatedToggleButton#ToggleButton",
  "controlStyles[83].styles[0]": "AccessKey=7",
  "controlStyles[83].styles[1]": "//Target= Control Center Button#7",
  
  "controlStyles[84].target": "GridViewItem[8] > Windows.UI.Xaml.Controls.Primitives.ListViewItemPresenter#Root > ContentControl > ContentPresenter > Grid > Grid > ControlCenter.PaginatedToggleButton#ToggleButton",
  "controlStyles[84].styles[0]": "AccessKey=8",
  "controlStyles[84].styles[1]": "//Target= Control Center Button#8",
  
  "controlStyles[85].target": "GridViewItem[9] > Windows.UI.Xaml.Controls.Primitives.ListViewItemPresenter#Root > ContentControl > ContentPresenter > Grid > Grid > ControlCenter.PaginatedToggleButton#ToggleButton",
  "controlStyles[85].styles[0]": "AccessKey=9",
  "controlStyles[85].styles[1]": "//Target= Control Center Button#9",
  
  "controlStyles[86].target": "GridViewItem[10] > Windows.UI.Xaml.Controls.Primitives.ListViewItemPresenter#Root > ContentControl > ContentPresenter > Grid > Grid > ControlCenter.PaginatedToggleButton#ToggleButton",
  "controlStyles[86].styles[0]": "AccessKey=0",
  "controlStyles[86].styles[1]": "//Target= Control Center Button#10",
  
  "controlStyles[87].target": "GridViewItem[11] > Windows.UI.Xaml.Controls.Primitives.ListViewItemPresenter#Root > ContentControl > ContentPresenter > Grid > Grid > ControlCenter.PaginatedToggleButton#ToggleButton",
  "controlStyles[87].styles[0]": "AccessKey=-",
  "controlStyles[87].styles[1]": "//Target= Control Center Button#11",
  
  "controlStyles[88].target": "GridViewItem[1] > Windows.UI.Xaml.Controls.Primitives.ListViewItemPresenter#Root > ContentControl > ContentPresenter > Grid > ControlCenter.PaginatedToggleButton#ToggleButton",
  "controlStyles[88].styles[0]": "AccessKey=1",
  "controlStyles[88].styles[1]": "//Target= Control Center Button#1",
  
  "controlStyles[89].target": "GridViewItem[2] > Windows.UI.Xaml.Controls.Primitives.ListViewItemPresenter#Root > ContentControl > ContentPresenter > Grid > ControlCenter.PaginatedToggleButton#ToggleButton",
  "controlStyles[89].styles[0]": "AccessKey=2",
  "controlStyles[89].styles[1]": "//Target= Control Center Button#2",
  
  "controlStyles[90].target": "GridViewItem[3] > Windows.UI.Xaml.Controls.Primitives.ListViewItemPresenter#Root > ContentControl > ContentPresenter > Grid > ControlCenter.PaginatedToggleButton#ToggleButton",
  "controlStyles[90].styles[0]": "AccessKey=3",
  "controlStyles[90].styles[1]": "//Target= Control Center Button#3",
  
  "controlStyles[91].target": "GridViewItem[4] > Windows.UI.Xaml.Controls.Primitives.ListViewItemPresenter#Root > ContentControl > ContentPresenter > Grid > ControlCenter.PaginatedToggleButton#ToggleButton",
  "controlStyles[91].styles[0]": "AccessKey=4",
  "controlStyles[91].styles[1]": "//Target= Control Center Button#4",
  
  "controlStyles[92].target": "GridViewItem[5] > Windows.UI.Xaml.Controls.Primitives.ListViewItemPresenter#Root > ContentControl > ContentPresenter > Grid > ControlCenter.PaginatedToggleButton#ToggleButton",
  "controlStyles[92].styles[0]": "AccessKey=5",
  "controlStyles[92].styles[1]": "//Target= Control Center Button#5",
  
  "controlStyles[93].target": "GridViewItem[6] > Windows.UI.Xaml.Controls.Primitives.ListViewItemPresenter#Root > ContentControl > ContentPresenter > Grid > ControlCenter.PaginatedToggleButton#ToggleButton",
  "controlStyles[93].styles[0]": "AccessKey=6",
  "controlStyles[93].styles[1]": "//Target= Control Center Button#6",
  
  "controlStyles[94].target": "GridViewItem[7] > Windows.UI.Xaml.Controls.Primitives.ListViewItemPresenter#Root > ContentControl > ContentPresenter > Grid > ControlCenter.PaginatedToggleButton#ToggleButton",
  "controlStyles[94].styles[0]": "AccessKey=7",
  "controlStyles[94].styles[1]": "//Target= Control Center Button#7",
  
  "controlStyles[95].target": "GridViewItem[8] > Windows.UI.Xaml.Controls.Primitives.ListViewItemPresenter#Root > ContentControl > ContentPresenter > Grid > ControlCenter.PaginatedToggleButton#ToggleButton",
  "controlStyles[95].styles[0]": "AccessKey=8",
  "controlStyles[95].styles[1]": "//Target= Control Center Button#8",
  
  "controlStyles[96].target": "GridViewItem[9] > Windows.UI.Xaml.Controls.Primitives.ListViewItemPresenter#Root > ContentControl > ContentPresenter > Grid > ControlCenter.PaginatedToggleButton#ToggleButton",
  "controlStyles[96].styles[0]": "AccessKey=9",
  "controlStyles[96].styles[1]": "//Target= Control Center Button#9",
  
  "controlStyles[97].target": "GridViewItem[10] > Windows.UI.Xaml.Controls.Primitives.ListViewItemPresenter#Root > ContentControl > ContentPresenter > Grid > ControlCenter.PaginatedToggleButton#ToggleButton",
  "controlStyles[97].styles[0]": "AccessKey=0",
  "controlStyles[97].styles[1]": "//Target= Control Center Button#10",
  
  "controlStyles[98].target": "GridViewItem[11] > Windows.UI.Xaml.Controls.Primitives.ListViewItemPresenter#Root > ContentControl > ContentPresenter > Grid > ControlCenter.PaginatedToggleButton#ToggleButton",
  "controlStyles[98].styles[0]": "AccessKey=-",
  "controlStyles[98].styles[1]": "//Target= Control Center Button#11",
  
  "controlStyles[99].target": "Grid#RootGrid > QuickActions.ControlCenter.FrameWithContentChanged#L2Frame",
  "controlStyles[99].styles[0]": "Background=Transparent",
  "controlStyles[99].styles[1]": "//Target= (No Idea, used to solve an issue before 24H2)",
  
  "controlStyles[100].target": "QuickActions.ControlCenter.AccessibleWindow#PageWindow",
  "controlStyles[100].styles[0]": "Background=Transparent",
  "controlStyles[100].styles[1]": "//Target= (No Idea, used to solve an issue before 24H2)",
